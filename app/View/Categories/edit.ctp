...
<div class="grid_17">
	...
	<div class="box_top">
		...
		<h2 class="icon frames">Edit Kategori</h2>
	...
	<div class="box_content padding">
		...
		<div class="field">
			...
			echo $this->Form->input('pict_baru', array(
						'label' => 'Gambar', 
						'title' => 'Gambar Background Kategori Baru', 
						'class' => 'medium tip-stay',
						'type' => 'file',
						'error' => array('attributes' => array('wrap' => 'p', 'class' => 'error right small'))
						)
			);
			/*echo $this->Html->image('kategori/'.$this->request->data['Category']['pict'], 
										array(
											'title' => h($this->request->data['Category']['name']),
											'alt' => h($this->request->data['Category']['name']),
											'width' => '112px',
											'height' => '61px',
											)
										);*/
		...
		<div class="field">
			<?php
			echo $this->Form->input('long_pict_baru', array(
						'label' => 'Gambar Panjang', 
						'title' => 'Gambar Panjang Kategori Baru', 
						'class' => 'medium tip-stay',
						'type' => 'file',
						'error' => array('attributes' => array('wrap' => 'p', 'class' => 'error right small'))
						)
