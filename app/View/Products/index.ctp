...
<div class="grid_17">
	...
	<div class="box_top">
		...
		<h2 class="icon frames">Produk <!-- <span class="tip" title="Tips can be added everywhere">254</span> --></h2>
			...
			<div id="listing">
				...
				<div class="dataTables_wrapper">
					<div class="dataTables_filter">
						<form method="post" action="<?php echo $this->base."/products"; ?>">
					...
					<table>
						<thead>
							<tr>
								<th class="align_left"><?php echo $this->Paginator->sort('Product.name', 'Nama');?></th>
						...
						<?php
							...
							<tr class="gradeA">
								<td class="align_left"><?php echo h($hasil['Product']['name']); ?>&nbsp;</td>
								...
								<td class="align_left tools center sorting">
									<?php echo $this->Html->link(__('View'), array('action' => 'view', $hasil['Product']['id']), array('class' => 'view tip', 'title' => 'view')); ?>
									<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $hasil['Product']['id']), array('class' => 'edit tip', 'title' => 'edit')); ?>
									<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $hasil['Product']['id']), array('class' => 'delete tip', 'title' => 'delete'), __('Anda yakin akan menghapus produk # %s?', $hasil['Product']['name'])); ?>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
