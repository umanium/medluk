...
<div class="grid_17">
	...
	<div class="box_top">
		...
		<h2 class="icon frames">Edit Produk #3 <!-- <span class="tip" title="Tips can be added everywhere">254</span> --></h2>
	...
	<div class="box_content padding">
		...
		<div class="field">
			<?php
			echo $this->Html->link('Tambah', array('controller' => 'selling_units', 'action' => 'add', 'edit', $id), array('class' => 'button')); 
			?>
			<table>
				<thead>
					<tr>
						...
						for($i = 0; $i < count($selling_units); $i++){
							...
							<tr class="gradeA">
								...
								<td class="align_left tools center sorting">
									<?php echo $this->Html->link(__('Edit'), array('controller' => 'selling_units', 'action' => 'edit', $selling_units[$i]['SellingUnit']['id'], 'edit', $id), array('class' => 'edit tip', 'title' => 'edit')); ?>
									<?php echo $this->Html->link(__('Delete'), array('controller' => 'selling_units', 'action' => 'delete', $selling_units[$i]['SellingUnit']['id'], 'edit', $id), array('class' => 'delete tip', 'title' => 'delete'), __('Anda yakin akan menghapus selling unit # %s?', $selling_units[$i]['SellingUnit']['name'])); ?>
								</td>
							</tr>
							<?php
						}
