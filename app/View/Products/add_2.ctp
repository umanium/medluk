...
<div class="grid_17">
	...
	<div class="box_top">
		...
		<h2 class="icon frames">Tambah Produk #2 <!-- <span class="tip" title="Tips can be added everywhere">254</span> --></h2>
		...
		<div class="field">
			...
			<!--<div class="box_radio" id="box_radio1">-->
				...
				/*for($i = 0; $i < count($produkTerkait); $i++){
					...
					<input type="radio" name="data[Product][product_terkait1]" value="<?php echo $produkTerkait[$i]['Product']['id']; ?>" />
		...
		<div class="field">
			...
			<!--<div class="box_radio" id="box_radio2">-->
				...
				/*for($i = 0; $i < count($produkTerkait); $i++){
					...
					<input type="radio" name="data[Product][product_terkait2]" value="<?php echo $produkTerkait[$i]['Product']['id']; ?>" />
