...
<div class="grid_17">
	...
	<div class="box_top">
		...
		<h2 class="icon frames">Brand <!-- <span class="tip" title="Tips can be added everywhere">254</span> --></h2>
			...
			<div id="listing">
				...
				<div class="dataTables_wrapper">
					<div class="dataTables_filter">
						<form method="post" action="<?php echo $this->base."/brands"; ?>">
					...
					<table>
						...
						<tbody>
						<?php
							foreach ($brands as $hasil): ?>
							<tr class="gradeA">
								<td class="align_left"><?php echo h($hasil['Brand']['name']); ?>&nbsp;</td>
								<td class="align_left center"><?php echo ($hasil['Brand']['publish'] == 'y')? 'Ya' : 'Tidak' ; ?>&nbsp;</td>
								<td class="align_left tools center sorting">
									<?php echo $this->Html->link(__('View'), array('action' => 'view', $hasil['Brand']['id']), array('class' => 'view tip', 'title' => 'view')); ?>
									<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $hasil['Brand']['id']), array('class' => 'edit tip', 'title' => 'edit')); ?>
									<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $hasil['Brand']['id']), array('class' => 'delete tip', 'title' => 'delete'), __('Anda yakin akan menghapus brand # %s?', $hasil['Brand']['name'])); ?>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
