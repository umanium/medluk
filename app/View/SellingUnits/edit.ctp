...
<div class="grid_17">
	...
	<div class="box_top">
		...
		<h2 class="icon frames">Edit Selling Unit <!-- <span class="tip" title="Tips can be added everywhere">254</span> --></h2>
		...
		<div class="field">
			...
			<div class="box_radio">
				...
				for($i = 0; $i < count($colours); $i++){
					...
					for($a = 0; $a < count($sellingColour); $a++){
						if($sellingColour[$a]['SellingUnitsColour']['colour_id'] == $colours[$i]['Colour']['id']){
							?>
							
							<input type="checkbox" checked="checked" name="data[SellingUnit][colour][]" value="<?php echo $colours[$i]['Colour']['id']; ?>" />
							<?php
