<div class="coloursProducts index">
	<h2><?php echo __('Colours Products');?></h2>
	...
	<?php
	foreach ($coloursProducts as $coloursProduct): ?>
	<tr>
		<td><?php echo h($coloursProduct['ColoursProduct']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $coloursProduct['ColoursProduct']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $coloursProduct['ColoursProduct']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $coloursProduct['ColoursProduct']['id']), null, __('Are you sure you want to delete # %s?', $coloursProduct['ColoursProduct']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
